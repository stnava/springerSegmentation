...
"training takes approximately 16 hours, prediction for a single image takes approximately 18 seconds on the GPU, plus/minus a little depending on the model. I can easily scale that down by using a better architecture."
