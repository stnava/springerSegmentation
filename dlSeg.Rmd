...
### 5.1 apply the system to  held-out data

* report Dice overlap for tissues in training data and held out validation data

* does Dice overlap for CSF, GM or DGM vary with age?

* does Dice overlap for CSF, GM or DGM  vary with gender?

* Computation time for the methods
...
### 6.1 biologically motivated metrics
