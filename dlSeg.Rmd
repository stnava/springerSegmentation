...
FIXME say something here as introduction

### 2.1 biologically motivated metrics 
...
* unit tests / sanity checks that the split is valid
...
"training takes approximately 16 hours, prediction for a single image takes approximately 18 seconds on the GPU, plus/minus a little depending on the model. I can easily scale that down by using a better architecture."  FIXME need to know number of training images and architecture used for this ... ie how many networks etc.
