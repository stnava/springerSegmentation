...
![Three images randomly selected from the DLBS cohort.](`r cohfn`)

![FIXME figure showing system](`r arfn`)

![A comparison of the ground truth segmentation (center) to the convolution network's output.](`r resfn`)
